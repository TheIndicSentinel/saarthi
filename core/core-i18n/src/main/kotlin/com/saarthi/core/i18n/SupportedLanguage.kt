...
enum class SupportedLanguage(
    ...
    /** Battery-optimization dialog: title (asks to keep long replies from being cut off). */
    ...
    /** Battery-optimization dialog: body. Avoids OS jargon like "battery optimization". */
    val batteryOptExplanation: String get() = when (this) {
        ENGLISH  -> "Samsung and other phones can still stop Saarthi mid-reply to save battery — even while a notification is showing. Allowing Saarthi to keep running in the background keeps long answers going. Chats stay on this phone."
        HINDI    -> "सैमसंग और अन्य फ़ोन बैटरी बचाने के लिए सारथी को जवाब के बीच में रोक सकते हैं — सूचना दिखने पर भी। सारथी को बैकग्राउंड में चलने देने से लंबे जवाब चलते रहते हैं। चैट इसी फ़ोन पर रहती है।"
        TAMIL    -> "சாம்சங் மற்றும் பிற போன்கள் பேட்டரியைச் சேமிக்க பதிலின் நடுவில் சாரதியை நிறுத்தலாம் — அறிவிப்பு தெரிந்தாலும். பின்னணியில் சாரதி இயங்க அனுமதித்தால் நீண்ட பதில்கள் தொடரும். உரையாடல் இந்த போனிலேயே இருக்கும்."
        TELUGU   -> "శామ్‌సంగ్ మరియు ఇతర ఫోన్లు బ్యాటరీ ఆదా చేయడానికి సమాధానం మధ్యలో సారథిని ఆపవచ్చు — నోటిఫికేషన్ కనిపించినా. సారథిని బ్యాక్‌గ్రౌండ్‌లో నడిపితే పొడవైన సమాధానాలు కొనసాగుతాయి. చాట్ ఈ ఫోన్‌లోనే ఉంటుంది."
        BENGALI  -> "স্যামসাং ও অন্যান্য ফোন ব্যাটারি বাঁচাতে উত্তরের মাঝে সারথিকে থামাতে পারে — নোটিফিকেশন দেখা গেলেও। ব্যাকগ্রাউন্ডে সারথিকে চলতে দিলে লম্বা উত্তর চলতে থাকে। চ্যাট এই ফোনেই থাকে।"
        MARATHI  -> "सॅमसंग आणि इतर फोन बॅटरी वाचवण्यासाठी उत्तराच्या मध्ये सारथी थांबवू शकतात — सूचना दिसली तरी. सारथीला बॅकग्राउंडमध्ये चालू दिल्यास लांब उत्तरे सुरू राहतात. चॅट या फोनवरच राहते."
        KANNADA  -> "ಸ್ಯಾಮ್‌ಸಂಗ್ ಮತ್ತು ಇತರೆ ಫೋನ್‌ಗಳು ಬ್ಯಾಟರಿ ಉಳಿಸಲು ಉತ್ತರದ ನಡುವೆ ಸಾರಥಿಯನ್ನು ನಿಲ್ಲಿಸಬಹುದು — ಅಧಿಸೂಚನೆ ಕಾಣಿಸಿದರೂ. ಹಿನ್ನೆಲೆಯಲ್ಲಿ ಸಾರಥಿ ಚಲಿಸಲು ಅನುಮತಿಸಿದರೆ ದೀರ್ಘ ಉತ್ತರಗಳು ಮುಂದುವರಿಯುತ್ತವೆ. ಚಾಟ್ ಈ ಫೋನ್‌ನಲ್ಲೇ ಇರುತ್ತದೆ."
        GUJARATI -> "સેમસંગ અને અન્ય ફોન બેટરી બચાવવા જવાબ વચ્ચે સારથીને અટકાવી શકે છે — નોટિફિકેશન દેખાય તો પણ. સારથીને બૅકગ્રાઉન્ડમાં ચાલવા દેવાથી લાંબા જવાબો ચાલુ રહે છે. ચેટ આ ફોન પર જ રહે છે."
        PUNJABI  -> "ਸੈਮਸੰਗ ਅਤੇ ਹੋਰ ਫੋਨ ਬੈਟਰੀ ਬਚਾਉਣ ਲਈ ਜਵਾਬ ਵਿਚਾਲੇ ਸਾਰਥੀ ਨੂੰ ਰੋਕ ਸਕਦੇ ਹਨ — ਸੂਚਨਾ ਦਿਖਣ 'ਤੇ ਵੀ। ਸਾਰਥੀ ਨੂੰ ਬੈਕਗ੍ਰਾਊਂਡ ਵਿੱਚ ਚੱਲਣ ਦੇਣ ਨਾਲ ਲੰਬੇ ਜਵਾਬ ਚੱਲਦੇ ਰਹਿੰਦੇ ਹਨ। ਚੈਟ ਇਸ ਫੋਨ 'ਤੇ ਹੀ ਰਹਿੰਦੀ ਹੈ।"
        ODIA     -> "ସ୍ୟାମସଙ୍ଗ ଓ ଅନ୍ୟ ଫୋନ୍ ବ୍ୟାଟେରୀ ବଞ୍ଚାଇବାକୁ ଉତ୍ତର ମଝିରେ ସାରଥୀକୁ ବନ୍ଦ କରିପାରେ — ବିଜ୍ଞପ୍ତି ଦେଖାଗଲେ ମଧ୍ୟ। ସାରଥୀକୁ ବ୍ୟାକଗ୍ରାଉଣ୍ଡରେ ଚାଲିବାକୁ ଦେଲେ ଲମ୍ବା ଉତ୍ତର ଚାଲୁ ରହେ। ଚାଟ୍ ଏହି ଫୋନରେ ରହେ।"
    }
