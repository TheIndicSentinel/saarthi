...
enum class SupportedLanguage(
    ...
    val notifPermTitle: String get() = when (this) {
        ENGLISH  -> "Keep replies from stopping?"
        HINDI    -> "जवाब बीच में न रुकें?"
        TAMIL    -> "பதில்கள் நடுவில் நில்லாமல் இருக்கட்டுமா?"
        TELUGU   -> "సమాధానాలు మధ్యలో ఆగకుండా ఉండాలా?"
        BENGALI  -> "উত্তর মাঝপথে থেমে যাবে না?"
        MARATHI  -> "उत्तरे मध्येच थांबू नयेत?"
        KANNADA  -> "ಉತ್ತರಗಳು ಮಧ್ಯದಲ್ಲಿ ನಿಲ್ಲದಿರಲಿ?"
        GUJARATI -> "જવાબો વચ્ચે અટકે નહીં?"
        PUNJABI  -> "ਜਵਾਬ ਵਿਚਾਲੇ ਨਾ ਰੁਕਣ?"
        ODIA     -> "ଉତ୍ତର ମଝିରେ ନ ଅଟକିବ?"
    }
    /** Battery-optimization dialog: body explaining why the exemption is needed. */
    val batteryOptExplanation: String get() = when (this) {
        ENGLISH  -> "Samsung and other phones can still stop Saarthi mid-reply to save battery — even while a notification is showing. Allowing Saarthi to skip battery optimization keeps long answers running. Chats stay on this phone."
        HINDI    -> "सैमसंग और अन्य फ़ोन बैटरी बचाने के लिए सारथी को जवाब के बीच में रोक सकते हैं — सूचना दिखने पर भी। बैटरी ऑप्टिमाइज़ेशन छोड़ने से लंबे जवाब चलते रहते हैं। चैट इसी फ़ोन पर रहती है।"
        TAMIL    -> "சாம்சங் மற்றும் பிற போன்கள் பேட்டரியைச் சேமிக்க பதிலின் நடுவில் சாரதியை நிறுத்தலாம் — அறிவிப்பு தெரிந்தாலும். பேட்டரி மேம்படுத்தலைத் தவிர்த்தால் நீண்ட பதில்கள் தொடரும். உரையாடல் இந்த போனிலேயே இருக்கும்."
        TELUGU   -> "శామ్‌సంగ్ మరియు ఇతర ఫోన్లు బ్యాటరీ ఆదా చేయడానికి సమాధానం మధ్యలో సారథిని ఆపవచ్చు — నోటిఫికేషన్ కనిపించినా. బ్యాటరీ ఆప్టిమైజేషన్ దాటవేస్తే పొడవైన సమాధానాలు కొనసాగుతాయి. చాట్ ఈ ఫోన్‌లోనే ఉంటుంది."
        BENGALI  -> "স্যামসাং ও অন্যান্য ফোন ব্যাটারি বাঁচাতে উত্তরের মাঝে সারথিকে থামাতে পারে — নোটিফিকেশন দেখা গেলেও। ব্যাটারি অপ্টিমাইজেশন এড়ালে লম্বা উত্তর চলতে থাকে। চ্যাট এই ফোনেই থাকে।"
        MARATHI  -> "सॅमसंग आणि इतर फोन बॅटरी वाचवण्यासाठी उत्तराच्या मध्ये सारथी थांबवू शकतात — सूचना दिसली तरी. बॅटरी ऑप्टिमायझेशन वगळल्यास लांब उत्तरे सुरू राहतात. चॅट या फोनवरच राहते."
        KANNADA  -> "ಸ್ಯಾಮ್‌ಸಂಗ್ ಮತ್ತು ಇತರೆ ಫೋನ್‌ಗಳು ಬ್ಯಾಟರಿ ಉಳಿಸಲು ಉತ್ತರದ ನಡುವೆ ಸಾರಥಿಯನ್ನು ನಿಲ್ಲಿಸಬಹುದು — ಅಧಿಸೂಚನೆ ಕಾಣಿಸಿದರೂ. ಬ್ಯಾಟರಿ ಆಪ್ಟಿಮೈಸೇಶನ್ ಬಿಟ್ಟರೆ ದೀರ್ಘ ಉತ್ತರಗಳು ಮುಂದುವರಿಯುತ್ತವೆ. ಚಾಟ್ ಈ ಫೋನ್‌ನಲ್ಲೇ ಇರುತ್ತದೆ."
        GUJARATI -> "સેમસંગ અને અન્ય ફોન બેટરી બચાવવા જવાબ વચ્ચે સારથીને અટકાવી શકે છે — નોટિફિકેશન દેખાય તો પણ. બેટરી ઑપ્ટિમાઇઝેશન છોડવાથી લાંબા જવાબો ચાલુ રહે છે. ચેટ આ ફોન પર જ રહે છે."
        PUNJABI  -> "ਸੈਮਸੰਗ ਅਤੇ ਹੋਰ ਫੋਨ ਬੈਟਰੀ ਬਚਾਉਣ ਲਈ ਜਵਾਬ ਵਿਚਾਲੇ ਸਾਰਥੀ ਨੂੰ ਰੋਕ ਸਕਦੇ ਹਨ — ਸੂਚਨਾ ਦਿਖਣ 'ਤੇ ਵੀ। ਬੈਟਰੀ ਓਪਟੀਮਾਈਜ਼ੇਸ਼ਨ ਛੱਡਣ ਨਾਲ ਲੰਬੇ ਜਵਾਬ ਚੱਲਦੇ ਰਹਿੰਦੇ ਹਨ। ਚੈਟ ਇਸ ਫੋਨ 'ਤੇ ਹੀ ਰਹਿੰਦੀ ਹੈ।"
        ODIA     -> "ସ୍ୟାମସଙ୍ଗ ଓ ଅନ୍ୟ ଫୋନ୍ ବ୍ୟାଟେରୀ ବଞ୍ଚାଇବାକୁ ଉତ୍ତର ମଝିରେ ସାରଥୀକୁ ବନ୍ଦ କରିପାରେ — ବିଜ୍ଞପ୍ତି ଦେଖାଗଲେ ମଧ୍ୟ। ବ୍ୟାଟେରୀ ଅପ୍ଟିମାଇଜେସନ୍ ଏଡ଼ାଇଲେ ଲମ୍ବା ଉତ୍ତର ଚାଲୁ ରହେ। ଚାଟ୍ ଏହି ଫୋନରେ ରହେ।"
    }
    ...
    /** Chat banner while the engine reloads after a background memory release. */
    val reloadingModelBanner: String get() = when (this) {
        ENGLISH  -> "The model was released to free memory. Loading it again — a few seconds."
        HINDI    -> "मेमोरी खाली करने के लिए मॉडल छोड़ा गया था। फिर से लोड हो रहा है — कुछ सेकंड।"
        TAMIL    -> "நினைவகத்தை காலி செய்ய மாடல் விடுவிக்கப்பட்டது. மீண்டும் ஏற்றப்படுகிறது — சில வினாடிகள்."
        TELUGU   -> "మెమరీ ఖాళీ చేయడానికి మోడల్ విడుదలైంది. మళ్లీ లోడ్ అవుతోంది — కొన్ని సెకన్లు."
        BENGALI  -> "মেমরি খালি করতে মডেল ছেড়ে দেওয়া হয়েছিল। আবার লোড হচ্ছে — কয়েক সেকেন্ড।"
        MARATHI  -> "मेमरी मोकळी करण्यासाठी मॉडेल सोडले होते. पुन्हा लोड होत आहे — काही सेकंद."
        KANNADA  -> "ಮೆಮೊರಿ ಖಾಲಿ ಮಾಡಲು ಮಾದರಿಯನ್ನು ಬಿಡುಗಡೆ ಮಾಡಲಾಗಿತ್ತು. ಮತ್ತೆ ಲೋಡ್ ಆಗುತ್ತಿದೆ — ಕೆಲವು ಸೆಕೆಂಡುಗಳು."
        GUJARATI -> "મેમરી ખાલી કરવા મોડેલ છોડવામાં આવ્યું હતું. ફરી લોડ થઈ રહ્યું છે — થોડી સેકંડ."
    ...
    val downloadRiskTitle: String get() = when (this) {
        ENGLISH  -> "Download this large file now?"
        HINDI    -> "यह बड़ी फ़ाइल अभी डाउनलोड करें?"
        TAMIL    -> "இந்த பெரிய கோப்பை இப்போது பதிவிறக்கவா?"
        TELUGU   -> "ఈ పెద్ద ఫైల్‌ను ఇప్పుడు డౌన్‌లోడ్ చేయాలా?"
        BENGALI  -> "এই বড় ফাইল এখনই ডাউনলোড করবেন?"
        MARATHI  -> "ही मोठी फाइल आता डाउनलोड करायची?"
        KANNADA  -> "ಈ ದೊಡ್ಡ ಫೈಲ್ ಅನ್ನು ಈಗ ಡೌನ್‌ಲೋಡ್ ಮಾಡಬೇಕೇ?"
        GUJARATI -> "આ મોટી ફાઇલ હમણાં ડાઉનલોડ કરવી?"
        PUNJABI  -> "ਇਹ ਵੱਡੀ ਫਾਈਲ ਹੁਣ ਡਾਊਨਲੋਡ ਕਰਨੀ ਹੈ?"
        ODIA     -> "ଏହି ବଡ଼ ଫାଇଲ୍ ବର୍ତ୍ତମାନ ଡାଉନଲୋଡ୍ କରିବେ?"
    }
    val downloadRiskCellular: String get() = when (this) {
        ENGLISH  -> "You're on mobile data. This model is over 2 GB and will use your data plan."
        HINDI    -> "आप मोबाइल डेटा पर हैं। यह मॉडल 2 GB से बड़ा है और आपके प्लान का डेटा लगेगा।"
        TAMIL    -> "நீங்கள் மொபைல் தரவில் உள்ளீர்கள். இந்த மாடல் 2 GB-க்கு மேல்; உங்கள் திட்டத் தரவைப் பயன்படுத்தும்."
        TELUGU   -> "మీరు మొబైల్ డేటాలో ఉన్నారు. ఈ మోడల్ 2 GB కంటే పెద్దది; మీ ప్లాన్ డేటా వాడుతుంది."
        BENGALI  -> "আপনি মোবাইল ডেটায় আছেন। এই মডেল ২ GB-এর বেশি এবং আপনার প্ল্যানের ডেটা খরচ হবে।"
        MARATHI  -> "तुम्ही मोबाइल डेटावर आहात. हे मॉडेल २ GB पेक्षा मोठे आहे आणि तुमच्या प्लॅनचा डेटा लागेल."
        KANNADA  -> "ನೀವು ಮೊಬೈಲ್ ಡೇಟಾದಲ್ಲಿದ್ದೀರಿ. ಈ ಮಾದರಿ 2 GB ಗಿಂತ ದೊಡ್ಡದು; ನಿಮ್ಮ ಪ್ಲಾನ್ ಡೇಟಾ ಬಳಸುತ್ತದೆ."
        GUJARATI -> "તમે મોબાઇલ ડેટા પર છો. આ મોડેલ 2 GBથી મોટું છે અને તમારા પ્લાનનો ડેટા વાપરશે."
        PUNJABI  -> "ਤੁਸੀਂ ਮੋਬਾਈਲ ਡਾਟਾ 'ਤੇ ਹੋ। ਇਹ ਮਾਡਲ 2 GB ਤੋਂ ਵੱਡਾ ਹੈ ਅਤੇ ਤੁਹਾਡੇ ਪਲਾਨ ਦਾ ਡਾਟਾ ਲੱਗੇਗਾ।"
        ODIA     -> "ଆପଣ ମୋବାଇଲ୍ ଡାଟାରେ ଅଛନ୍ତି। ଏହି ମଡେଲ୍ 2 GB ରୁ ବଡ଼; ଆପଣଙ୍କ ପ୍ଲାନ୍ ଡାଟା ଖର୍ଚ୍ଚ ହେବ।"
    }
    val downloadRiskLowBattery: String get() = when (this) {
        ENGLISH  -> "Battery is below 30% and the phone is not charging. A multi-GB download can drain the battery and fail if the phone sleeps."
        HINDI    -> "बैटरी 30% से कम है और फ़ोन चार्ज नहीं हो रहा। कई GB का डाउनलोड बैटरी गिरा सकता है और फ़ोन सो जाए तो रुक सकता है।"
        TAMIL    -> "பேட்டரி 30%-க்கு கீழ்; போன் சார்ஜ் ஆகவில்லை. பல GB பதிவிறக்கம் பேட்டரியை காலி செய்து, போன் உறங்கினால் நிற்கலாம்."
        TELUGU   -> "బ్యాటరీ 30% కంటే తక్కువ; ఫోన్ ఛార్జ్ కావడం లేదు. చాలా GB డౌన్‌లోడ్ బ్యాటరీని ఖాళీ చేసి, ఫోన్ నిద్రపోతే ఆగవచ్చు."
        BENGALI  -> "ব্যাটারি ৩০%-এর নিচে এবং ফোন চার্জ হচ্ছে না। কয়েক GB ডাউনলোড ব্যাটারি ফাঁকা করতে পারে, ফোন ঘুমালে থেমে যেতে পারে।"
        MARATHI  -> "बॅटरी ३०% पेक्षा कमी आहे आणि फोन चार्ज होत नाही. कित्येक GB चे डाउनलोड बॅटरी संपवू शकते आणि फोन झोपला तर थांबू शकते."
        KANNADA  -> "ಬ್ಯಾಟರಿ 30% ಕ್ಕಿಂತ ಕಡಿಮೆ; ಫೋನ್ ಚಾರ್ಜ್ ಆಗುತ್ತಿಲ್ಲ. ಹಲವು GB ಡೌನ್‌ಲೋಡ್ ಬ್ಯಾಟರಿ ಖಾಲಿ ಮಾಡಬಹುದು, ಫೋನ್ ನಿದ್ರಿಸಿದರೆ ನಿಲ್ಲಬಹುದು."
        GUJARATI -> "બેટરી 30%થી ઓછી છે અને ફોન ચાર્જ થતો નથી. કેટલાક GBનું ડાઉનલોડ બેટરી ખાલી કરી શકે અને ફોન ઊંઘે તો અટકી શકે."
        PUNJABI  -> "ਬੈਟਰੀ 30% ਤੋਂ ਘੱਟ ਹੈ ਅਤੇ ਫੋਨ ਚਾਰਜ ਨਹੀਂ ਹੋ ਰਿਹਾ। ਕਈ GB ਡਾਊਨਲੋਡ ਬੈਟਰੀ ਖਤਮ ਕਰ ਸਕਦਾ ਹੈ ਅਤੇ ਫੋਨ ਸੌਣ 'ਤੇ ਰੁਕ ਸਕਦਾ ਹੈ।"
        ODIA     -> "ବ୍ୟାଟେରୀ 30% ରୁ କମ୍ ଏବଂ ଫୋନ୍ ଚାର୍ଜ ହେଉନାହିଁ। ବହୁ GB ଡାଉନଲୋଡ୍ ବ୍ୟାଟେରୀ ଖାଲି କରିପାରେ, ଫୋନ୍ ଶୋଇଲେ ବନ୍ଦ ହୋଇପାରେ।"
    }
    val downloadAnywayLabel: String get() = when (this) {
        ENGLISH  -> "Download anyway"
        HINDI    -> "फिर भी डाउनलोड करें"
        TAMIL    -> "இருந்தாலும் பதிவிறக்கு"
        TELUGU   -> "అయినా డౌన్‌లోడ్ చేయి"
        BENGALI  -> "তবুও ডাউনলোড করুন"
        MARATHI  -> "तरीही डाउनलोड करा"
        KANNADA  -> "ಆದರೂ ಡೌನ್‌ಲೋಡ್ ಮಾಡಿ"
        GUJARATI -> "છતાં ડાઉનલોડ કરો"
        PUNJABI  -> "ਫਿਰ ਵੀ ਡਾਊਨਲੋਡ ਕਰੋ"
        ODIA     -> "ତଥାପି ଡାଉନଲୋଡ୍ କରନ୍ତୁ"
    }
