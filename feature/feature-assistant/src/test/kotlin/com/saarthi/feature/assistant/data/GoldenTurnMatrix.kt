...
internal fun goldenTurnMatrixCases(): List<GoldenMatrixCase> {
    ...
    return listOf(
        ...
        GoldenMatrixCase(
            id = "attach_overview_tight_budget",
            archetype = GoldenQueryArchetype.ATTACH_OVERVIEW,
            query = ATTACH_OVERVIEW_QUERY,
            docs = listOf(act),
            attachmentsThisTurn = true,
        ...
        GoldenMatrixCase(
            id = "topical_breach_timeline_no_doc_words",
            archetype = GoldenQueryArchetype.OFF_TOPIC_AMBIGUOUS,
            ...
            expectCite = true,
            expectStrongMatch = true,
            retrievedTextMustContain = listOf("breach"),
        ),
        GoldenMatrixCase(
            id = "deictic_topical_minors",
            archetype = GoldenQueryArchetype.OFF_TOPIC_AMBIGUOUS,
            query = "Does it apply to minors",
            docs = listOf(act),
            expectedMode = RagTurnMode.DOCUMENT_GROUNDED,
            minRagChars = 40,
            minChunkCount = 1,
        ...
        GoldenMatrixCase(
            id = "financial_statement_balance",
            archetype = GoldenQueryArchetype.FINANCIAL_STATEMENT,
            query = "what is the salary credit amount in the statement",
            docs = pair,
            expectedMode = RagTurnMode.DOCUMENT_GROUNDED,
            minRagChars = 40,
            minChunkCount = 1,
            ...
            expectStrongMatch = true,
            expectedTopDocUri = GoldenFixtures.STMT_URI,
            retrievedTextMustContain = listOf("50,000"),
        ),
        GoldenMatrixCase(
            id = "ticket_pnr_lookup",
            archetype = GoldenQueryArchetype.TICKET_RECEIPT,
            query = "what is the PNR number in this ticket file",
            docs = listOf(GoldenFixtures.ticket),
            expectedMode = RagTurnMode.DOCUMENT_GROUNDED,
            minRagChars = 40,
            minChunkCount = 1,
            expectedTopDocUri = GoldenFixtures.TICKET_URI,
            retrievedTextMustContain = listOf("ABCD1234"),
        ),
        GoldenMatrixCase(
            id = "guide_primary_obligations",
            archetype = GoldenQueryArchetype.GUIDE_PRIMARY_MIXED,
            query = "What are obligations of data fiduciary in this act",
            docs = GoldenFixtures.guideAndAct,
            expectedMode = RagTurnMode.DOCUMENT_GROUNDED,
            minRagChars = 60,
            minChunkCount = 1,
            expectCite = true,
            expectStrongMatch = true,
            expectedTopDocUri = DpdpaActFixture.URI,
            retrievedTextMustContain = listOf("OBLIGATIONS", "Data Fiduciary"),
        ),
        GoldenMatrixCase(
            id = "guide_primary_penalties_section",
            archetype = GoldenQueryArchetype.GUIDE_PRIMARY_MIXED,
            query = "What are penalties in section 33 of the act",
            docs = GoldenFixtures.guideAndAct,
            expectedMode = RagTurnMode.DOCUMENT_GROUNDED,
            minRagChars = 60,
            minChunkCount = 1,
            ...
            expectStrongMatch = true,
            expectedTopDocUri = DpdpaActFixture.URI,
            retrievedTextMustContain = listOf("33. Penalties"),
        ),
        GoldenMatrixCase(
